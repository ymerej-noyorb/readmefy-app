...
export default function Hero() {
	return (
		<section className="max-w-7xl mx-auto flex justify-between md:flex-row items-center gap-12">
			<div className="w-full md:w-2/3 md:text-left flex flex-col gap-6">
				<h2 className="text-5xl text-blue-500 font-bold mb-4">
				...
				>
					Try It Now
					<CursorArrowRaysIcon className="size-8 ml-2" />
				</a>
			</div>
